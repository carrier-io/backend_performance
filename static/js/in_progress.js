const PerformanceTestProgress = {
    ...
    methods: {
        async poll_updates() {
            const response = await fetch(`/api/v1/backend_performance/reports/${this.project_id}/?report_id=${this.test_id}`)
...
register_component('performancetestprogress', PerformanceTestProgress)